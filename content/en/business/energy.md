...
1.  **Catalysts & Adsorbents**: Hydrotreating and hydrocracking catalysts, FCC catalysts and additives (CO promoters, SOx transfer agents, octane boosters), continuous reforming catalysts, Claus sulphur recovery catalysts, guard beds and arsenic / chloride / oxygen removal adsorbents, molecular sieves.
2.  **Crude & Unit Processing Aids**: Crude demulsifiers, desalting aids, overhead corrosion inhibitors (neutralising and filming amines), antifoulants and anti-coking agents, metal passivators, defoamers.
3.  **Gas Treating, Desulphurisation & deNOx**: Amine solvents (MDEA / DEA / MEA), amine reclaiming agents and antifoams, hydrogen sulphide scavengers, desiccants, SCR reducing agents and urea.
...
* Specification and key properties (assay, particle size, activity, distillation range)
* Annual volume or batch quantity
* Destination port and Incoterms
* Whether an SDS, dangerous goods packaging certificate or other shipping documents are required
